...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    is_instructor = models.BooleanField(
        default=False, verbose_name='Create Account As A Instructor?')
...
class InstructorProfile(models.Model):
    ...
    profile_image = models.ImageField(
        upload_to='instructor_image', null=True, blank=True)
...
class LearnerProfile(models.Model):
    ...
    profile_image = models.ImageField(upload_to='learner_image')
    full_name = models.CharField(max_length=20, null=True, blank=True)
    study_in = models.CharField(
        max_length=2, choices=class_choice, null=True, blank=True)
    insti_name = models.CharField(max_length=100, null=True, blank=True)
